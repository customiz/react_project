...
class Monitor extends Component {
    ...
    constructor(props) {
        ...
        this.cencelOder = this.cencelOder.bind(this);
        this.confirmOder = this.confirmOder.bind(this);
    }
            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    ...
                    <div className="col-md-3">
                        <Calculator totalPrice={this.state.totalPrice} orders={this.state.orders} onDelOrder={this.delOrder} onCancelOrder={this.cencelOder} onConfirmOrder={this.confirmOder}/>
                    </div>
                </div>
            </div>
        )
